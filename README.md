...
```bash
go get -u github.com/genji1037/comfy2go@latest
```
Next, include Comfy2go client (and optionally the graph) APIs in your application:
```go
import "github.com/genji1037/comfy2go/client"
import "github.com/genji1037/comfy2go/graphapi"
```
## Usage
...
import (
	...
	"github.com/genji1037/comfy2go/client"
)
